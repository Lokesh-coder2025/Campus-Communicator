...
interface IconProps {
  // FIX: Added 'pitch' to the list of allowed icon types to support the pitch control.
  type: 'play' | 'stop' | 'magic' | 'volume' | 'save' | 'load' | 'rate' | 'bell' | 'close' | 'history' | 'pitch';
  className?: string;
}
